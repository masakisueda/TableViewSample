...
SWIFT_CLASS("_TtC13TableViewTest11AppDelegate")
...
SWIFT_CLASS("_TtC13TableViewTest19CustomTableViewCell")
@interface CustomTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified label;
- (void)awakeFromNib;
+ (CGFloat)sizeForCell:(UITableView * __nonnull)tableView text:(NSString * __nonnull)text;
...
SWIFT_CLASS("_TtC13TableViewTest14ViewController")
